...
Simulation done using dronekit_sitl
...
try:
        ...
        start_lidar = livox_python(dir='/home/hackfest08/Documents/ws_livox')
        #start_lidar.start_rviz_and_connect()
        ...
        '''
        time.sleep(2)
        print("executing fly_square")
        vehicle.fly_square(6,  altitude = target_altitude, pos_precision=posDev, speed=1)
        '''
