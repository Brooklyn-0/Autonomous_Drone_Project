...
def get_distance_meters(aLocation1, aLocation2):
  ...
  '''
  dalt_meters = aLocation2.alt - aLocation1.alt
  return math.sqrt(get_ground_distance_meters(aLocation1, aLocation2) ** 2 + (dalt_meters) ** 2)


def get_ground_distance_meters(aLocation1, aLocation2):
    """
    Returns the ground distance in meters between two LocationGlobal objects.
    This method is an approximation, and will not be accurate over large distances and close to the
    earth's poles. It comes from the ArduPilot test code:
    https://github.com/diydrones/ardupilot/blob/master/Tools/autotest/common.py
    """
    lon1, lat1 = aLocation1.lon, aLocation1.lat
    lon2, lat2 = aLocation2.lon, aLocation2.lat
